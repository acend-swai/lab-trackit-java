...
Every requirement below is testable - a MockMvc test must be writable from it. Follow the
pattern in `backend/src/test/java/ch/acend/trackit/web/TaskControllerTest.java`.
